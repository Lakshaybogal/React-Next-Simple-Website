...
const DrawingCanvas = () => {
  ...
  return (
    <section className={`font-mono ${state ? "DARK" : "LIGHT"} flex flex-col items-center`}>
      <h1 className="text-4xl md:text-5xl font-extrabold text-center py-5">Web Theme Change</h1>
      {
        state ? <h1>
          Context is True
        </h1> :
      ...
      <button
        onClick={() => route.push('context-pages')}>
        Page 2
      </button>
      <button

        onClick={() => route.push('context-pages/home-page')}>
        Page 3
      </button>
